...
\usepackage{listings}
\lstset{basicstyle=\small,showstringspaces=false,tabsize=3,float=htbp,floatplacement=htbp}
% Reducir el espacio que LaTeX inserta alrededor de floats "in-text"
% (por defecto 12pt). Hace que las figuras, tablas y listados queden
% más pegados al texto que los introduce.
\setlength{\intextsep}{6pt plus 2pt minus 2pt}
\setlength{\textfloatsep}{10pt plus 2pt minus 4pt}
% Evita que LaTeX estire verticalmente las páginas para justificar el
% margen inferior. Sin esto, las páginas con un float que no llena
% completamente el cuerpo distribuyen el sobrante como glue alrededor
% del float, creando espacios visibles arriba/abajo de los listados.
\raggedbottom
...
% Reglas tipográficas profesionales para tablas (\toprule, \midrule, \bottomrule).
\usepackage{booktabs}
...
\addto\captionsspanish{%
  ...
  \def\lstlistlistingname{Índice de códigos}%
}
...
% amsmath / amssymb: necesarios para el modelo formal del motor de
% navegación (entornos align, equation; símbolos \mathcal, \mathbb,
% \langle, \rangle, \llbracket, etc.). amsthm habilita los entornos
% \begin{definition}, \begin{proposition} que se utilizan en la
% subsección "Modelo formal de navegación".
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsthm}
\usepackage{stmaryrd} % \llbracket / \rrbracket para la semántica [[ s ]]
...
\lstdefinestyle{pythonStyle}{
    ...
    numberstyle=\tiny,
    frame=single,
    backgroundcolor=\color{violet!5},
    float=htbp
}
...
\lstdefinelanguage{Golang}{
    morekeywords=[1]{package,import,func,var,const,type,struct,interface,
        map,chan,return,if,else,for,range,switch,case,default,break,
        continue,go,defer,select,fallthrough,goto},
    morekeywords=[2]{int,int8,int16,int32,int64,uint,uint8,uint16,uint32,
        uint64,float32,float64,string,bool,byte,rune,error,any,nil,
        true,false,iota},
    sensitive=true,
    morecomment=[l]{//},
    morecomment=[s]{/*}{*/},
...
\lstdefinestyle{goStyle}{
    language=Golang,
    keywordstyle=\color{cyan!70!black}\bfseries,
...
% TikZ para diagramas vectoriales (p.ej. figura de arquitectura)
\usepackage{tikz}
\usetikzlibrary{positioning, shapes.geometric, arrows.meta, fit, calc}

% UML class diagrams (modelo en memoria)
\usepackage{pgf-umlcd}

% UML sequence diagrams (interacciones link/goback/union, flujo HTTP)
