...
los resultados guardados durante la sesión. La validación funcional se ha realizado sobre un
volcado del catálogo público TMDB y la usabilidad de la interfaz se ha evaluado mediante un
protocolo formal de pruebas con usuarios.
