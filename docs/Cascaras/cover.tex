...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\autorPortada{Juan Andrés Hibjan Cardona\\Leonardo Prado de Souza}
...
\fechaPublicacion{25 de Mayo de 2026}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\directorPortada{José Luis Sierra Rodríguez}
...
\textbf{Convocatoria: }\textit{{Junio} \the\year}\\[0.3em]
\textbf{Calificación}\\[0.2em]
Juan Andrés Hibjan Cardona: \textit{10.0 (Matrícula de honor)}\\[0.1em]
Leonardo Prado de Souza: \textit{10.0 (Matrícula de honor)}
}
