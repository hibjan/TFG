...
% Gráficas vectoriales para el capítulo de Pruebas y Validación
\usepackage{pgfplots}
...
\include{Capitulos/ArquitecturaYMetodologia}
\include{Capitulos/DesarrolloEImplementacion}
\include{Capitulos/PruebasYValidacion}
