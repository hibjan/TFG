...
project, the objectives pursued, the execution plan, and the organization of the memoir.
...
enumerates the natural continuation lines identified from the state of the work. The
