...
en la cual el usuario necesita de una cantidad cada vez mayor de tiempo para navegar.
...
Ese abordaje permite recoger colecciones de manera interactiva, con mecanismos de navegación más expresivos 
...
las cuales se describen a continuación en sendas subsecciones.
...
hemos centralizado los esfuerzos en la eficacia, eficiencia y robustez técnica de los componentes del sistema.
...
Es ese momento hemos definido el estado de la cuestión basándonos en artículos de investigación previos, 
...
Además de consumir la API, se diseñó un proceso de transformación y almacenamiento de los datos en nuestro modelo relacional,
...
Tras definir la API, se desarrolló una interfaz web para la interacción con el motor de navegación.
Entre sus principales componentes están: el área de resultados, sistema de filtrado dinámico de metadatos,
...
Unimos todos los componentes, hicimos pruebas de carga con los \textit{datasets} completos y evaluamos la experiencia
de usuario (\textit{UX}).
